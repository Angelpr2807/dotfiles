...
for i = 1, 6 do
    hl.workspace_rule({ workspace = i, monitor = vars.monitor1 })
end

for i = 7, 8 do
    hl.workspace_rule({ workspace = i, monitor = vars.monitor2 })
end
...
hl.window_rule({
    name = "kitty-focus-opacity",
    match = {
        class = "kitty",
    },
    opacity = "1.0 override 0.75 override",
    no_blur = true
})
